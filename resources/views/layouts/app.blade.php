...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/assets/img/crowne.png" alt="AdminLTE Logo" class="brand-image img-circle bg-light elevation-3" style="opacity: .8">
      <span class="brand-text px-2"><strong>ADMIN</strong></span>
    </a>
